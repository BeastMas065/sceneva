  ...
  return (
    <div className="min-h-screen flex flex-col relative overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none -z-10">
        ...
        <div className="absolute top-0 left-0 w-[50%] h-[60%] bg-gradient-to-br from-glow/[0.15] via-glow/[0.06] to-transparent blur-[100px]" />
        <div className="absolute bottom-0 right-0 w-[60%] h-[50%] bg-gradient-to-tl from-accent/[0.12] via-accent/[0.04] to-transparent blur-[80px]" />
        <div className="absolute top-1/3 right-1/3 w-[40%] h-[40%] bg-gradient-to-bl from-glow/[0.08] to-transparent blur-[60px]" />
        
        {/* Projector light beams */}
        <div className="absolute top-0 left-1/3 w-[3px] h-[70%] bg-gradient-to-b from-glow/25 via-glow/8 to-transparent blur-[2px] rotate-5" />
        <div className="absolute top-0 right-1/3 w-[3px] h-[70%] bg-gradient-to-b from-glow/25 via-glow/8 to-transparent blur-[2px] -rotate-5" />
