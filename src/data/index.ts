...
import { Scores, initialScores, getQuestionsForModeAndContent, getRandomVariant } from './questions';
export { Scores, initialScores, getQuestionsForModeAndContent, getRandomVariant };
